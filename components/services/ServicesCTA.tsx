...
export default function ServicesCTA() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      const tl = gsap.timeline({
        ...
        scrollTrigger: { trigger: "[data-sc-card]", start: "top 80%" },
      });

      tl.from("[data-sc-card]", {
        ...
        .from("[data-sc-word]", {
          yPercent: 120, rotateX: -50, opacity: 0, filter: "blur(10px)",
          stagger: 0.08, duration: 0.9,
        }, "-=0.5")
        .from("[data-sc-sub]", { y: 24, opacity: 0, filter: "blur(6px)", duration: 0.7 }, "-=0.4")
        .from("[data-sc-actions] > *", { y: 30, opacity: 0, scale: 0.9, stagger: 0.12, duration: 0.6 }, "-=0.3")
        .from("[data-sc-meta] > *", { y: 20, opacity: 0, stagger: 0.1, duration: 0.6 }, "-=0.2");

      gsap.to("[data-sc-ring]", { rotate: 360, duration: 44, ease: "none", repeat: -1 });
  ...
  return (
    ...
    >
      <div data-sc-orb className="absolute inset-0 pointer-events-none">
        ...
        >
          ...
          <div className="relative">
            ...
            >
              ...
              <span className="inline-block overflow-hidden align-bottom mr-[0.25em]">
                <span data-sc-word className="inline-block">the</span>
              </span>
              <span className="inline-block overflow-hidden align-bottom">
                <span data-sc-word className="inline-block">problem.</span>
              </span>
            </h2>

            <p data-sc-sub className="text-base md:text-lg text-gray-400 max-w-xl mx-auto mb-12 leading-relaxed">
              You don&apos;t need a brief written yet. Tell us what&apos;s not working and
              we&apos;ll tell you which of the thirteen actually fixes it — even if
              the answer is &ldquo;none of them.&ldquo;
            </p>

            <div data-sc-actions className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button
                ref={btnRef}
